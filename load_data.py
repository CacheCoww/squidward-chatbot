...
def readVocs(datafile, transcript_name):
    print("Reading lines...")
...
def loadPrepareData(transcripts, transcript_name, datafile, save_dir):
    print("Start preparing training data ...")
    voc, pairs = readVocs(datafile, transcript_name)
